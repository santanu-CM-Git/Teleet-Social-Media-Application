                      ...
                      child: Column(
                        children: [
                                ...
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: ProfileImagePicker(
                                      ...
                                      imageURL: SessionManager.shared
                                          .getUser()
                                          ?.profile,
                                      controller: controller,
                                      boxSize: 140,
                                ...
                                return Column(
                                  children: [
                                    CreateRoomHeading(
                                      title: LKeys.bio,
                                      bracketText:
                                          "(${controller.bioEditController.text.length}/${Limits.bioCount})",
                                    ),
                                    // DetectableTextField(
                                    ...
                                    //   decoration: InputDecoration(hintText: LKeys.writeHere.tr, hintStyle: MyTextStyle.gilroyRegular(color: cLightText.withOpacity(0.6)), border: InputBorder.none, counterText: '', isDense: true, contentPadding: const EdgeInsets.all(0)),
                                    ...
                                    MyTextField(
                                      controller: controller.bioEditController,
                                      placeHolder:
                                          LKeys.writeSomethingAboutYourSelf.tr,
                                      isEditor: true,
                          ...
                          SafeArea(
                            top: false,
                            child: CommonButton(
                                text: LKeys.update, onTap: controller.onSubmit),
                          ),
          ...
          builder: (controller) {
            ...
            return ClipSmoothRect(
              radius: SmoothBorderRadius.all(SmoothRadius(
                  cornerRadius: radius - 2, cornerSmoothing: cornerSmoothing)),
              child: Container(
                  width: double.infinity,
                  height: 220,
                  decoration: ShapeDecoration(
