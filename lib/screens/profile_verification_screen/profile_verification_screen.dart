              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(border: Border.all(color: controller.selectedPackage == package ? cPrimary : cLightText.withOpacity(0.3), width: 2), borderRadius: SmoothBorderRadius(cornerRadius: 12)),
                    child: Row(
                      children: [
                        Text(
