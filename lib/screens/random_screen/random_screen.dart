                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        TopBarForOnBoarding(
                            ...
                            desc: '',
                            titleStart:
                                isProfile ? LKeys.profile : LKeys.searching),
                      ],
                    ),
                    const Spacer(),
                    isProfile
                        ...
                        : RipplesAnimation(
                            ...
                            child: MyCachedImage(
                              imageUrl:
                                  SessionManager.shared.getUser()?.profile,
                              width: 100,
                              height: 100,
                            )),
                    const Spacer(),
                    Container(
                      ...
                      margin: EdgeInsets.only(
                          bottom: isProfile ? 40 : 60, right: 40, left: 40),
                      child: isProfile
                          ? CommonButton(
                              text: LKeys.next, onTap: controller.next)
    ...
    return Container(
      decoration: ShapeDecoration(
          ...
          shape: SmoothRectangleBorder(
            borderRadius: SmoothBorderRadius(
                cornerRadius: 25, cornerSmoothing: cornerSmoothing),
          )),
      ...
      child: Column(
        ...
        children: [
                      ...
                      children: [
                        Flexible(
                          child: Text(
                            ...
                            style:
                                MyTextStyle.gilroyBold(color: cWhite, size: 17),
                            maxLines: 1,
          ...
          Wrap(
            children:
                (controller.user?.getInterestsStringList() ?? []).map((e) {
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  border: Border.all(color: cDarkText.withOpacity(0.5)),
