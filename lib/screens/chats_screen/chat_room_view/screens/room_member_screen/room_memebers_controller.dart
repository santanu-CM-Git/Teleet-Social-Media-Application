        ...
        Get.bottomSheet(ConfirmationSheet(
          ...
          onTap: () {
            ...
            RoomService.shared
              ...
              chattingController.chatUserRoom?.usersIds
                  ?.removeWhere((element) => element == user.id);
              chattingController.db
                  .collection(FirebaseConst.chats)
                  .doc(chattingController.chatUserRoom?.conversationId ?? '')
                  .update(chattingController.chatUserRoom?.toFireStore() ?? {});
