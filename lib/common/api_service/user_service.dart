...
class UserService {
  ...
  void searchProfile(
      String keyword, int start, Function(List<User> users) completion) {
    var param = {
  ...
  void checkForUserPhone(
      String username, num? user_id, Function(bool) completion) {
    ApiService.shared.client?.close();
    ApiService.shared.call(
        url: WebService.checkPhone,
        param: {Param.username: username, Param.userId: user_id},
        completion: (value) {
          var response = CommonResponse.fromJson(value);
          completion(response.status ?? false);
        });
  ...
  void validateOtp(
      num? user_id, String username, String otp, Function(bool) completion) {
    ApiService.shared.client?.close();
    ApiService.shared.call(
        url: WebService.validateOtp,
        param: {
  ...
  void editProfile({
    ...
    if (is_phone_verify != null) {
      param[Param.is_phone_verify] = is_phone_verify;
    }
