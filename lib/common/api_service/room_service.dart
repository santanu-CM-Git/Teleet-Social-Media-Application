...
class RoomService {
  ...
  void fetchRoomUsersList(num roomId, num start, Function(List<RoomMember> users) completion) {
    var param = {
      Param.roomId: roomId,
      Param.start: start,
  ...
  void searchUserForInvitation(num roomId, String keyword, int start, Function(List<User> users) completion) {
  ...
  void fetchRoomByInterest(int interestId, int start, Function(List<Room> rooms) completion) {
