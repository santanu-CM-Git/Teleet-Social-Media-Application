                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      width: double.infinity,
                      decoration: BoxDecoration(
                        gradient: LinearGradient(colors: [cBlack.withOpacity(0.7), Colors.transparent, Colors.transparent, Colors.transparent, Colors.transparent], begin: Alignment.topCenter, end: Alignment.bottomCenter),
                      ),
                    ),
                    Visibility(
                    ...
                    Visibility(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                            color: Colors.black.withOpacity(isKeyboardOn ? 0.6 : 0),
                        ...
                        Expanded(
                          child: Container(
                            ...
                            decoration: ShapeDecoration(
                              shape: StadiumBorder(side: BorderSide(color: cWhite.withOpacity(0.6), width: 1)),
                            ),
                            height: 40,
                            width: double.infinity,
                            alignment: Alignment.center,
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintStyle: MyTextStyle.gilroyRegular(color: cLightText.withOpacity(0.8)),
