        ...
        children: [
          GestureDetector(
            ...
            child: Container(
              ...
              decoration:
                  const BoxDecoration(color: cBlack, shape: BoxShape.circle),
  ...
  void onTakePictureButtonPressed(context) {
    takePicture(context).then((String? filePath) async {
      if (_controller?.value.isInitialized == true) {
        if (filePath != null) {
          var color = widget.filterColor == null
              ? _filterColor.value
              : widget.filterColor!.value;
          Navigate.to(ResultView(
            isVideo: false,
...
class StoryImagePicker extends StatelessWidget {
  ...
  const StoryImagePicker(
      {super.key, required this.imageSource, required this.onGetPath});
